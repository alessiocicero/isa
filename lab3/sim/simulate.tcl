...
vcom -93 -work ./work ../src/a-DataPath/a.b-DEC/Decode_Logic.vhd
...
vcom -93 -work ./work ../src/a-DataPath/a.c-EXE/ALU.vhd
...
vcom -93 -work ./work ../src/b-ControlUnit.vhd
...
vsim -novopt work.tb_riscv_lite "+firmware=code.hex" "+data=data.hex" "+verbose" "+vcd"
radix hex
add wave *
