analyze -f vhdl -lib WORK ../src/c-constants.vhd
...
analyze -f vhdl -lib WORK ../src/a-DataPath/a.b-DEC/Decode_Logic.vhd
...
analyze -f vhdl -lib WORK ../src/a-DataPath/a.c-EXE/ALU.vhd
...
analyze -f vhdl -lib WORK ../src/b-ControlUnit.vhd
...
write -f verilog -hierarchy -output ../netlist/RISCV_lite.v
